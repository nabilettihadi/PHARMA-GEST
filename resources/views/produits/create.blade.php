...
<body class="bg-gray-100">
    <!-- Sidebar -->
    <aside class="bg-gray-800 text-white h-screen w-64 fixed top-0 left-0 flex flex-col justify-between transition-all duration-300 ease-in-out">
        ...
        <main class="container mx-auto px-4 py-12">
            <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
                ...
                <form action="{{ route('produits.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <button type="submit"
                        class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg w-full sm:w-auto">Ajouter</button>
                </form>
            </div>
        </main>
    </main>
