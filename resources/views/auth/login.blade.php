        ...
        <div class="w-full max-w-sm">
            <div class="form-container p-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="mb-4">
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="Adresse Email" class="bg-gray-100 w-full py-2 px-4 rounded-md outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-md w-full">Se connecter</button>
                </form>
